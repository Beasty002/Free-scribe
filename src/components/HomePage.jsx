...
export default function HomePage({ setAudiStream, setFile }) {
    return (
        <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 md:gap-5 justify-center pb-20'>
            ...
            <h3 className='font-semibold md:text-lg'>Record <span className='text-blue-400'>&rarr;</span> Transcribe
            ...
            <p className='text-base'>Or <label htmlFor="fileUpload" className='text-blue-400 cursor-pointer hover:text-blue-600 duration-200'>upload
                <input id='fileUpload' onChange={(e) => {
